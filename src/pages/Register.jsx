    ...
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-2/5 bg-gradient-to-br from-violet-950 via-zinc-950 to-indigo-950 border-r border-zinc-800 p-12">
        ...
        <div className="space-y-8">
          <div>
            <p className="text-3xl font-bold text-white mb-3 leading-tight">Start shortening links in seconds</p>
            <p className="text-zinc-500 text-sm leading-relaxed">
              Join thousands of teams using SnapURL to manage, track and optimize every link they share.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[["Free forever", "No credit card needed"], ["100 req/15min", "Fair rate limiting"], ["Real-time stats", "See clicks instantly"], ["QR codes", "Auto-generated"]].map(([title, sub]) => (
              <div key={title} className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800">
